...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2021 at 04:46 PM
...
(9, 'ayuuu@gmail.com', '12345678', 'Siti Aisyah Sri Rahayu', '08234858585', 'Paccerakkang');
...
(14362, 9, '2021-02-08', 'Disetujui', 22000000),
(14363, 9, '2021-02-08', 'Tidak Disetujui', 12700000);
...
--
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14364;

--
-- AUTO_INCREMENT for table `pembelian_produk`
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
